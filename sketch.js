...
function setup(){
	...
	body0 = new Body(color(random(255),random(255),random(255)), color(random(255),random(255),random(255)), color(random(255),random(255),random(255)),200,300,3);  //first body, random colors, location, speed
    body1 = new Body(color(random(255),random(255),random(255)), color(random(255),random(255),random(255)), color(random(255),random(255),random(255)),250,500,5);  //second body, random colors, location, speed
    body2 = new Body(color(random(255),random(255),random(255)), color(random(255),random(255),random(255)), color(random(255),random(255),random(255)),50,30,1);  //third body, random colors, location, speed
